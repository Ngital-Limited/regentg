...
export const projectLocations: ProjectLocation[] = [
  ...
  // Completed
  { name: "Regent Hasina", slug: "regent-hasina", location: "West Agargaon", status: "completed", lat: 23.8215, lng: 90.4440 },
  ...
  { name: "Regent Sufia", slug: "regent-sufia", location: "West Agargaon", status: "completed", lat: 23.8180, lng: 90.4400 },
