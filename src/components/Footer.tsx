...
import img_concordnoaddress from "@/assets/imported/concordnoaddress.webp";
import img_rehab_1024x265 from "@/assets/imported/rehab-1024x265.webp";
      ...
      <div className="container-regent py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-20">
          ...
          <div className="space-y-6">
            <img src="/regent-light-logo.png" alt="Regent" className="h-16 w-auto" />
            ...
            <div className="flex items-center gap-4 pt-2">
              {socials.map((social) => (
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d={social.path} /></svg>
                </a>
              ))}
            </div>
          </div>
